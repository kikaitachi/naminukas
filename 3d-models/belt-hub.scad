...
idler_height_p = 3; // [0.5:Tiny (0.5mm), 1:Small (1mm), 1.5:Normal (1.5mm), 2:Big (2mm), 3:Bigger (3mm), 4:Hudge (5mm)]
...
difference() {
    ...
    translate([0, 0, -0.1]) {
        cylinder(d = motor_shaft_diameter + 0.2, h = 20, $fn = 300);
    }
}